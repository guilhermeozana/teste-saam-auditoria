...
public class CadastroView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.ipadx = 432;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(25, 13, 34, 10);
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(20, 125, 0, 0);
        ...
        gridBagConstraints.ipadx = 432;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(25, 13, 0, 10);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(campoNome.getText().isEmpty() || campoEmail.getText().isEmpty() || campoSenha.getPassword().length == 0){
            Util.getAlert().alertNormal("Preencha todos os campos!");
            
            return;
        }
        
        UsuarioVO usuarioVO = new UsuarioVO(campoNome.getText(), campoEmail.getText(), new String(campoSenha.getPassword()));
        
        Response resposeCadastro = this.cadastroController.fazerCadastro(usuarioVO);
        
        if(!resposeCadastro.isError()) {
            this.dispose();
